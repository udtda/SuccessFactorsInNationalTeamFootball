...
##### Zweiter Step
# Zusammenstellung eines Modells mit den ausgewählten Variablen; Werte sind die Durschnittswerte aus Step 1
ldpgb.coef=resulttableLASSOavgGB[c("Intercept","shotAccuracy","DistanceCoveredComp","MarketValueCompFact", "SaveRate", "Tackles.Attempted", "Tackle.rate","Errors",  "Dribbles", "Passes...Length...Long"),3]
ldpgb.coef=as.matrix(ldpgb.coef)
rownames(ldpgb.coef)=c("Intercept","shotAccuracy","DistanceCoveredComp","MarketValueCompFact", "SaveRate", "Tackles.Attempted","Tackle.rate","Errors",   "Dribbles", "Passes...Length...Long")
